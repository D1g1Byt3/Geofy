...
public class ModTags {
    ...
    public static class Blocks{
        public static final Tags.IOptionalNamedTag<Block> SCANNING_ROD_VALUABLES =
                tag("scanning_rod_valuables");
        ...
        private static Tags.IOptionalNamedTag<Block> tag(String name){
            return BlockTags.createOptional(new ResourceLocation(GeofyMod.MOD_ID, name));
        }
    ...
    public static class Items{
        ...
        private static Tags.IOptionalNamedTag<Item> tag(String name){
            return ItemTags.createOptional(new ResourceLocation(GeofyMod.MOD_ID, name));
        }
